"""Retriever initialization for retrieval modelEvaluation."""
...
def initRetrievers(methods: list[str], assets: RetrievalAssets) -> dict[str, Any]:
    ...
    for method in methods:
        ...
        try:
            if method == "bm25":
                from core.retrieval.retrieverModules import BM25Retriever
                ...
                from core.retrieval.retrieverModules import HybridRetriever
