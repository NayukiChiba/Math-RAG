...
使用方法：
    python scripts/experiments/runExperiments.py
    python scripts/experiments/runExperiments.py --groups norag bm25 vector hybrid
    python scripts/experiments/runExperiments.py --limit 10  # 限制查询数量（调试用）
    python scripts/experiments/runExperiments.py --groups norag bm25 vector hybrid hybrid-rrf  # 含 RRF 对比
"""
...
class ExperimentRunner:
    ...
    def _initRetriever(self, strategy: str):
        ...
        if strategy == "bm25":
            from core.retrieval.retrieverModules import BM25PlusRetriever
            ...
            from core.retrieval.retrieverModules import VectorRetriever
            ...
            from core.retrieval.retrieverModules import HybridPlusRetriever
    ...
    def runRagExperiment(
        ...
        for i, q in enumerate(queries, 1):
            ...
            try:
                from core.answerGeneration.promptTemplates import buildMessages
