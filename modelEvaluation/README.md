...
# 调整 TopK
python modelEvaluation/evalRetrieval.py --topk 20

# 生成对比图表
python modelEvaluation/evalRetrieval.py --visualize

# 指定查询集和输出路径
python modelEvaluation/evalRetrieval.py \
...
# 使用全部查询
python modelEvaluation/quickEval.py --all-queries

# 输出报告
python modelEvaluation/quickEval.py --output reports/my_eval.json
```
